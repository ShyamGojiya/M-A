            ...
            <div className="w-full rounded-lg border-2 border-br bg-white sm:p-4 max-sm:p-2">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex flex-row justify-between">
                  ...
                  <span>₹{(cartTotal.reduce((paryialSum, n)=> paryialSum+n, 0)).toFixed(2)}</span>
                </div>

                <div className="flex flex-row justify-between">
                  <span>Cart discount: </span>
                  <span className="text-br">- ₹{(cartDiscount.reduce((paryialSum, n)=> paryialSum+n, 0)).toFixed(2)}</span>
                </div>
                ...
                <div className="flex flex-row justify-between">
                  ...
                  <span className="font-semibold">₹{((cartTotal.reduce((paryialSum, n)=> paryialSum+n, 0)) - (cartDiscount.reduce((paryialSum, n)=> paryialSum+n, 0))).toFixed(2)}</span>
                </div>

                <div className="w-full flex mt-4">
                  <button className="w-full py-2 bg-br text-white rounded-lg font-semibold hover:bg-green-800 uppercase" onClick={handlePayment}>
                    proceed to checkout
                  </button>
                </div>
              </div>
